...
<script>
<!-- 1-osa. Tällä functiolla sivu säilyttää päivityksen jälkeen sijainnin -->
...
<!-- 2. osa. Tämä on jatke sivun sijainnin löytämiseen päivittämisen jälkeen. -->
...
if(request.getParameter("added") != null && request.getParameter("added").equals("true")) {
	...
	%>
	<!-- Alert, jos käyttäjä yrittää lisätä pizzan ilman täytteitä -->
	<script>
...
<ul class="nav navbar-default nav-tabs navbar-fixed-top">
 ...
 <!----------------------------Nav bar--------------------------------> 
  ...
  <li><a href="http://proto293:8080/PizzeriaProjekti/kokkiController">Tilausnäkymä</a> </li> 
...
<!-- Pizzan lisäys lomake -->
	<form action="Controller" method="post">

		<b>Lisää Pizzan Tiedot</b>
		<br><br>
		...
		<div class="col-md-12">
                ...
                <div class="col-md-3">
                    ...
                    <div class="checkbox">
                        <label><input type="checkbox" name="tayte" value="Jalapeno ">Jalapeño</label>
                    </div>
					 <div class="checkbox">
		...
		<br>
			...
			<button id="lisaa" type="submit" name="action" value="lisaa">Lisää Pizza</button>
...
<!---------------------------End pizza_lisays -------------------------------------->
	...
	<!-- Pizzalistan tulostus sekä muokkaus ja poisto buttonit -->
...
<div class="col-md-12">
	...
	<table>
		...
		<caption>Näkyvyys 1 = esillä, näkyvyys 2 = piilossa.</caption>
		<thead>
			<tr>
				<td>ID</td>
				<td>NIMI</td>
		...
		for(int i=0; i < pizzat.size(); i++) {
			...
			<c:if test="${not empty param.added}">Pizzan lisäsys onnistui! </c:if>
		</tbody>
	</table>
</div> <!-- col12 tulostus -->

 <!----------------------------End Pizzojen tulostus--------------------------------> 
	<!-- Tällä funktiolla pakotetaan max 5 täytettä alerttia -->
